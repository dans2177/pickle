...
#ifndef PICKLEWATCH_WATCH_APP_SWIFT_H
#define PICKLEWATCH_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Picklewatch_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC21Picklewatch_Watch_App14WatchGameModel")
@interface WatchGameModel : NSObject <WCSessionDelegate>
