...
#ifndef PICKLEWATCH_SWIFT_H
#define PICKLEWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Picklewatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class UIWindow;
SWIFT_CLASS("_TtC11Picklewatch11AppDelegate")
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC11Picklewatch9GameModel")
@interface GameModel : NSObject <WCSessionDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
